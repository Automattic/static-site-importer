...
$public_data = Static_Site_Importer_Public_Error_Projection::project_public_error_data(
	array(
		'status'         => 'failed',
		'import_id'      => 'import-42',
...
$dependency_data = Static_Site_Importer_Public_Error_Projection::project_public_error_data(
	array(
		'dependency' => array(
			'slug'        => 'jetpack',
