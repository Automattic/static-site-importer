...
$theme_generator_admission_failure = $theme_generator_materialize->invoke( null, array(), array( 'slug' => 'theme-generator-reference-admission', '_static_site_importer_payload_reader' => $throwing_reader ), $reference_plan, array(), array( 'unreachable' => true ), array( 'dependencies' => array(), 'entities' => array() ), array() );
...
$block_lifecycle = array(
	'dependencies' => array(),
	'entities'     => array(
		'woo'  => array( 'adapter' => array( 'provider' => 'woocommerce', 'materializer' => static fn( array $manifest ): array => array( 'status' => 'completed', 'counts' => array( 'created' => 1 ), 'products' => array( array( 'slug' => $manifest['products'][0]['slug'] ) ) ), 'rollback_callback' => static function ( array $report ) use ( &$rollback_order ): array { $rollback_order[] = 'woo'; return array( 'status' => 'rolled_back' ); } ), 'manifest' => array( 'products' => array( array( 'slug' => 'late-rollback-product' ) ) ) ),
		'form' => array( 'adapter' => array( 'provider' => 'jetpack', 'materializer' => static fn( array $manifest ): array => array( 'status' => 'completed', 'counts' => array( 'created' => 1 ), 'forms' => array( array( 'source_path' => $manifest['forms'][0]['source_path'], 'selector' => '' ) ) ), 'rollback_callback' => static function ( array $report ) use ( &$rollback_order ): array { $rollback_order[] = 'form'; return array( 'status' => 'rolled_back' ); } ), 'manifest' => array( 'forms' => array( array( 'source_path' => 'index.html' ) ) ) ),
	),
);
$block_late_failure = $theme_generator_materialize->invoke( null, array(), array( 'slug' => 'block-entity-late-failure', 'seed_entities' => true, 'font_materialization' => array(), 'inject_materialization_failure' => 'report_persistence' ), $plan, array(), null, $block_lifecycle, array() );
...
$hostile_receipt = Static_Site_Importer_WordPress_Site_Plan_Materializer::materialize( $classic_plan, array( 'slug' => 'classic-hostile-direct', 'name' => 'Classic Hostile Direct', 'theme_materialization' => 'classic', 'classic_theme_projection' => $hostile_projection ) );
...
$invalid_projection['pages']['forged.html'] = array( 'source_path' => 'forged.html', 'html' => '<script>classic-hostile</script>' );
$invalid_projection_receipt = Static_Site_Importer_WordPress_Site_Plan_Materializer::materialize( $classic_plan, array( 'slug' => 'classic-invalid-direct', 'theme_materialization' => 'classic', 'classic_theme_projection' => $invalid_projection ) );
