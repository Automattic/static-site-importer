...
namespace {
	...
	$assert( empty( $native_submit_line_height_validation['errors'] ) && str_contains( (string) ( $native_submit_line_height_row['provider_layout_overlay_css']['css'] ?? '' ), 'padding:8px;line-height:normal' ), 'provider-submit-line-height-default-is-neutralized-when-the-source-omits-it', wp_json_encode( $native_submit_line_height_row ) );
