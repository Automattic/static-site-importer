...
namespace {
	...
	$assert( empty( $native_line_height_validation['errors'] ) && str_contains( $native_default_css, 'padding:8px;font-family:Arial;line-height:normal' ), 'provider-native-typography-defaults-are-neutralized-when-the-source-omits-them', $native_default_css );
	...
	$assert( empty( $validated_all_controls['errors'] ) && 4 === count( $all_controls_hooks ) && empty( array_filter( $all_controls_hooks, static fn( string $hook ): bool => ! str_contains( $all_controls_markup, $hook ) || ! str_contains( $all_controls_css, '.' . $hook ) ) ) && str_contains( $all_controls_css, 'border:1px solid #111;padding:7px;font-family:Arial;line-height:normal' ) && str_contains( $all_controls_css, 'border:2px solid #222;padding:8px;font-family:Arial;line-height:normal' ) && str_contains( $all_controls_css, 'border:3px solid #333;min-height:9rem;font-family:Arial;line-height:normal' ) && str_contains( $all_controls_css, 'background-color:#444;padding:9px 12px;font-family:Arial;line-height:normal;min-height:0' ) && str_contains( $all_controls_css, '@media (max-width:48rem){' ) && str_contains( $all_controls_css, '> .wp-block-button__link{background-color:#444;padding:9px 12px;font-family:Arial;line-height:normal;min-height:0}' ) && ! str_contains( $all_controls_css, 'control-shell' ) && ! str_contains( $all_controls_css, 'control-hook' ), 'presentation-overlay-preserves-native-typography-defaults-when-source-control-styles-omit-them', wp_json_encode( array( 'markup' => $all_controls_markup, 'css' => $all_controls_css, 'targets' => $all_controls_targets ) ) );
