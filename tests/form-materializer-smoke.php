...
namespace {
	...
	$phone_presentation['forms'][0]['presentation_graph']['controls'] = array( array( 'index' => 0, 'control' => $presentation_role( array( 'background_color' => '#fff', 'border_color' => '#1e4b6e', 'border_radius' => '0', 'font_size' => '16px', 'line_height' => '24px', 'padding' => '8px 12px', 'height' => '40px' ), array( 'background-color', 'border-color', 'border-radius', 'font-size', 'line-height', 'padding', 'height' ), 'input' ) ) );
	...
	$assert( empty( $validated_phone_presentation['errors'] ) && 'jetpack_phone' === ( $phone_presentation_target['control_provider'] ?? '' ) && str_contains( $phone_presentation_css, '--jetpack--contact-form--input-background:#fff' ) && str_contains( $phone_presentation_css, '--jetpack--contact-form--border-color:#1e4b6e' ) && str_contains( $phone_presentation_css, '--jetpack--contact-form--border-radius:0' ) && str_contains( $phone_presentation_css, '--jetpack--contact-form--font-size:16px' ) && str_contains( $phone_presentation_css, '--jetpack--contact-form--line-height:24px' ) && str_contains( $phone_presentation_css, '--jetpack--contact-form--input-padding:8px 12px' ) && str_contains( $phone_presentation_css, 'height:40px' ), 'phone-presentation-projects-proven-source-facts-into-jetpack-shell-variables', wp_json_encode( array( 'css' => $phone_presentation_css, 'target' => $phone_presentation_target ) ) );
