...
$assert( ! isset( $metadata['attributes']['themeMaterialization'] ), 'block-json-omits-theme-materialization-selector' );
...
$assert( ! str_contains( static_site_importer_render_block(), 'data-static-site-importer-theme-materialization' ), 'render-omits-theme-materialization-selector' );
...
$assert( ! str_contains( $view_js, 'theme_materialization' ), 'view-omits-theme-materialization-strategy' );
