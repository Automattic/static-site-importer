...
- `demos/playground-importer/` — separately packaged README Playground demo plugin containing the `static-site-importer/importer` block; excluded from the SSI runtime package.
