...
class Static_Site_Importer_Website_Artifact_Import_Input {
	...
	public const SCHEMA_PROPERTIES = array(
		...
		'source_provider_policy'               => array( 'type' => 'object' ),
	...
	public static function normalize( array $input, array $defaults = array() ): array {
		...
		foreach ( array( 'products_manifest', 'commerce_context', 'asset_map', 'compiler_options', 'source_metadata', 'source_provider_policy', 'validation_artifacts', 'quality_budget', 'client_script_provenance' ) as $field ) {
