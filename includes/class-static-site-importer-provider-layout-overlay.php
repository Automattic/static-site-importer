...
class Static_Site_Importer_Provider_Layout_Overlay {
	...
	public static function compile( array $graph, mixed $map, array $presentation_graph = array(), array $container = array(), bool $editor = false ): array {
		...
		$rules[]      = self::authoritative_presentation_selector( $validated_map['scope'] . '.jetpack-contact-form-container' ) . '{padding:0!important;margin:0!important;border:0!important}';
		$operations[] = array(
			'dimension'   => 'layout',
