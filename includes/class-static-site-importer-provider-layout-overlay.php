...
class Static_Site_Importer_Provider_Layout_Overlay {
	...
	private static function presentation_property_map(): array {
		...
		// A source control can be an explicitly placed flex/grid item or carry a
		// single physical inset while its shorts are already mapped, so the
		// provider representation needs these longhands too.
