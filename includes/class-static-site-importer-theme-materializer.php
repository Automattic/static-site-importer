...
class Static_Site_Importer_Theme_Materializer {
	 ...
	 */
	public static function base_theme_writes( string $theme_dir, string $theme_slug, string $theme_name, string $css, bool $has_header_part, bool $has_footer_part ): array {
		return array(
