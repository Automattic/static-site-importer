...
WP_CLI::line( wp_json_encode( array( 'status' => 'success', 'success' => true, 'runtime_presentation_evidence' => $evidence, 'artifact' => $merged_artifact_path ), JSON_UNESCAPED_SLASHES ) );`;
  return {
