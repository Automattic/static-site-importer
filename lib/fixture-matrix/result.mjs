...
export function writeFixtureMatrixResultArtifacts(input = {}) {
  ...
  writeJsonFile(path.join(outputDirectory, 'finding-packets.json'), {
    schema: 'static-site-importer/finding-packets/v2',
    matrix_id: result.matrix_id,
    fixture_coverage: result.summary.fixture_coverage || null,
