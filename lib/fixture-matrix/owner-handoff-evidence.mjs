...
function editorStatus(evidence) {
  ...
  if (!['static-site-importer/editor-presentation-evidence/v1', 'static-site-importer/editor-presentation-evidence/v2'].includes(presentation.schema) || presentation.coverage_complete == null) return 'evidence_gap';
  if (presentation.coverage_complete !== true) return 'hard_failure';
