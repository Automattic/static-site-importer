...
import { runtimePresentationEvidenceEnabled, runtimePresentationEvidenceProbeStep } from '../runtime-presentation-evidence.mjs';
...
function fixtureWorkflowSteps(options) {
  ...
  return [
    ...(runtimePresentationEvidence ? [runtimePresentationEvidenceProbeStep({
      fixture,
