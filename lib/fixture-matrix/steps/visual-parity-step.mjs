...
export function normalizeVisualParityRecipeOptions(input = {}) {
  ...
  return {
    ...
    animatedMedia: normalizeAnimatedMediaPolicy(input.animatedMedia ?? input.animated_media),
    ...normalizeVisualAttributionOptions(input),
  };
}

export function normalizeAnimatedMediaPolicy(value) {
  if (value === undefined || value === null || value === '') {
    return undefined;
  }
  const policy = String(value).trim();
  if (policy === 'allow' || policy === 'first-frame') {
    return policy;
  }
