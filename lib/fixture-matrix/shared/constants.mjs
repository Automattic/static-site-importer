...
export const GENERATED_ARTIFACT_METADATA_FILENAME = '.generated-artifact-metadata.json';
...
export const EDITOR_VISIBLE_PLACEHOLDER_KIND = 'editor_visible_placeholder';
export const EDITOR_VISIBLE_PLACEHOLDER_SELECTOR_GROUP = 'editor_visible_placeholder';
export const EDITOR_VISIBLE_PLACEHOLDER_SELECTORS = [
...
export const DOCUMENT_TITLE_MISMATCH_KIND = 'document_title_mismatch';
...
// Capture after a fixed post-DOM settle window so source/candidate screenshots
// see completed page-load/reveal animations instead of racing first paint.
export const DEFAULT_VISUAL_PARITY_WAIT_FOR = 'duration';
export const DEFAULT_VISUAL_PARITY_SETTLE_DURATION_MS = 4000;
export const VISUAL_PARITY_DETERMINISTIC_CSS = `
*, *::before, *::after {
...
.reveal, [class*="reveal-"], .pl, [class*="pl-"] {
...
export const DEFAULT_FINDING_GROUPS = {
  ...
  editor_visible_placeholder: {
    patterns: [/editor_visible_placeholder/i, /visible editor placeholder/i, /wp-block-group__placeholder/i],
    candidate_repo: 'blocks-engine',
    repair_mode: 'editor-presentation-parity',
  },
  document_title_mismatch: {
    patterns: [/document_title_mismatch/i, /document title mismatch/i],
    candidate_repo: 'static-site-importer',
    repair_mode: 'route-document-title-parity',
  },
  ...
  visual_timeout: {
    ...
    candidate_repo: 'static-site-importer',
    repair_mode: 'fixture-evidence-intake',
  },
  visual_evidence_missing: {
    patterns: [/visual_evidence_missing/i, /visual evidence missing/i, /visual-parity evidence missing/i],
    candidate_repo: 'static-site-importer',
    repair_mode: 'fixture-evidence-intake',
  },
  fixture_status_mismatch: {
    patterns: [/fixture_status_mismatch/i, /fixture status mismatch/i],
    candidate_repo: 'static-site-importer',
    repair_mode: 'fixture-result-normalization',
  },
  button_style_loss: {
...
export const ACCEPTED_RUNTIME_PRESERVATION_STATUSES = new Set([
  'accepted_runtime_preservation',
  'accepted-runtime-preservation',
]);
...
//
//   {
//     "fixture_class": "marketing/static",    // REQUIRED. One of FIXTURE_CLASSES, verbatim.
//     "class": "marketing/static",            // legacy alias, still accepted.
//     "tags": ["restaurant", "has-form"],     // optional. Free-form string array for lane/tag querying.
//     "capabilities": ["forms"],              // optional. Authored capability strings.
//     "risk_profile": "low",                  // optional. Authored risk lane.
//     "complexity": 1,                         // optional. Integer 1-5.
//     "quality_budgets": {}                    // optional. Authored budget metadata.
//     "allow_unproven_dynamic_client_assets": true // optional explicit runtime-preservation policy.
//   }
//
...
// is manifest-only (no heuristic fallback). Authored taxonomy fields are carried
// through onto each fixture, the per-fixture result, and the result summary so
// runs can be filtered/queried by class, tag, capability, and risk profile.
