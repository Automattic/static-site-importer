...
export function collectEditorPresentation(payload, matrixEvidence = null) {
  ...
  const assets = normalizeArray(plan.assets).length > 0 ? normalizeArray(plan.assets) : normalizeArray(evidencePlan.assets);
  ...
  return {
    ...
    coverage_complete: expectedIdentities.length > 0 && missingIdentities.length === 0,
  };
}
