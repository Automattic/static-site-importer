...
export { collectFixtureMatrixRunResults, collectMatrixEvidence } from './fixture-matrix/collectors/run-intake.mjs';

export { RUNTIME_PRESENTATION_EVIDENCE_SCHEMA, RUNTIME_PRESENTATION_EVIDENCE_UNAVAILABLE, runtimePresentationEvidenceEnabled, runtimePresentationEvidenceProbeStep, collectRuntimePresentationEvidence } from './fixture-matrix/runtime-presentation-evidence.mjs';
